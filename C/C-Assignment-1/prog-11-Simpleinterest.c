...
int main()
{
	...
	compound_interest=((pow((1+rate_of_interest/100.0),period)*principal_amount)- principal_amount);
	printf("%Lf\n",compound_interest);
	printf("Compound Interest when done semi-annually is:  ");
	compound_interest=((pow((1+rate_of_interest/200.0),2*period)*principal_amount)-principal_amount);
	printf("%Lf\n",compound_interest);
	printf("Compound Interest when done quarterly is:  ");
	compound_interest=((pow((1+rate_of_interest/400.0),4*period)*principal_amount)- principal_amount);
	printf("%Lf\n",compound_interest);
	printf("Compound Interest when done monthly is:  ");
	compound_interest=((pow((1+rate_of_interest/1200.0),12*period)*principal_amount)- principal_amount);
	printf("%Lf\n",compound_interest);
	printf("Compound Interest when done daily is:  ");
	compound_interest=((pow((1+rate_of_interest/36500.0),365*period)*principal_amount)- principal_amount);
	printf("%Lf\n",compound_interest);
